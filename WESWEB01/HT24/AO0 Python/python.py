...
# Loopar, loopar upprepar någonting en antal mängd gånger eller så länge någonting är på ett sant t.ex sant eller falskt.
# 'For' loopar körs en viss mängd gånger, t.ex den körs för varje föremål i en lista. Om en lista har sju föremål, körs loopen sju gånger.

# frukter = ["Persika", "Äpple", "Banan", "Päron", "Nektarin"]
# 
# for frukt in frukter:
#     print (f"{frukt} har {len(frukt)}st bokstäver i sig.")
# print ("Mums!")

# 'While' looper körs så länge är på ett viss sätt, t.ex true eller false. Om loopen körs när något är sant så slutar den när det blir falskt.

längd = int(input ("Ange din längd i cm: "))
while längd > 160:
    längd = int(input ("Ange din längd i cm: "))
print("Inga kortisar tillåtna!")